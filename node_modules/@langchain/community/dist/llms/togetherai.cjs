...
class TogetherAI extends llms_1.LLM {
    static lc_name() {
        return "TogetherAI";
    }
    constructor(inputs) {
        ...
        Object.defineProperty(this, "inferenceUrl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: "https://api.together.xyz/inference"
        });
        const apiKey = inputs.apiKey ?? (0, env_1.getEnvironmentVariable)("TOGETHER_AI_API_KEY");
        if (!apiKey) {
    ...
    async *_streamResponseChunks(prompt, options, runManager) {
        ...
        const stream = (0, event_source_parse_js_1.convertEventStreamToIterableReadableDataStream)(fetchResponse.body);
